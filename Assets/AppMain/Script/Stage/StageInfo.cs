...
public class StageData
{
    ...
    private const StageLevelInfo DefaultStageLevel = StageLevelInfo.STAGE_LEVEL_1;
    ...
    {
        _playerCount = DefaultPlayerCount;
        _enemyCount = DefaultEnemyCount;
        _enemyLevel = DefaultEnemyLevel;
        _stageLevel = DefaultStageLevel;
    }
}
